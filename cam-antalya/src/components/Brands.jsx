...
const brands = [
  {
    ...
    logoUrl: "/images/logo/pimapen.png", // URL'nizi buraya yapıştırın
  },
  {
    name: "Albert Genau",
    category: "Cam Balkon Sistemleri",
    logoUrl: "/images/logo/albert-genau.png", // URL'nizi buraya yapıştırın
  },
  {
    name: "Winsa",
    category: "PVC ve Cam Sistemleri",
    logoUrl: "/images/logo/winsa.png", // URL'nizi buraya yapıştırın
  },
  {
    name: "Rehau",
    category: "Yüksek Performans PVC",
    logoUrl: "/images/logo/rehau.svg", // URL'nizi buraya yapıştırın
  },
  {
    name: "Kömmerling",
    category: "Alman PVC Sistemleri",
    logoUrl: "/images/logo/kommerling.svg", // URL'nizi buraya yapıştırın
  },
  {
    name: "Adopen",
    category: "PVC ve Kapı Sistemleri",
    logoUrl: "/images/logo/adopen.png", // URL'nizi buraya yapıştırın
  },
  {
    name: "Schüco",
    category: "Premium Alüminyum",
    logoUrl: "/images/logo/schuco.svg", // URL'nizi buraya yapıştırın
  },
  {
    name: "Veka",
    category: "PVC Profiller",
    logoUrl: "/images/logo/veka.svg", // URL'nizi buraya yapıştırın
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Sistemlerimizde, enerji verimliliği ve dayanıklılık konusunda
            sektörün en güvenilir ve lider markalarını tercih ediyoruz.
          </p>
        </div>
              ...
              <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center mb-4 overflow-hidden border border-gray-200">
                ...
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.target.src =
                      "https://placehold.co/80x80/ef4444/ffffff?text=LOGO+YOK"; // Eğer resim yüklenemezse hata gösterir
                  }}
                />
              </div>
        ...
        <div className="mt-16 bg-blue-700 rounded-2xl p-8 md:p-12 text-white text-center shadow-2xl shadow-blue-700/40">
          ...
          <p className="text-blue-100 mb-8 max-w-2xl mx-auto text-lg">
            Projeleriniz için en uygun, garantili ve kaliteli çözümleri sunmak
            üzere uzman ekibimizle hemen iletişime geçin.
          </p>
          <a
